defmodule PomodoroTrackerWeb do
  @moduledoc """
  ...
  defp html_helpers do
    quote do
      ...
      import Phoenix.HTML
      # Core UI components
      import PomodoroTrackerWeb.CoreComponents

      # Common modules used in templates
      alias Phoenix.LiveView.JS
      alias PomodoroTrackerWeb.Layouts
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        endpoint: PomodoroTrackerWeb.Endpoint,
        router: PomodoroTrackerWeb.Router,
        statics: PomodoroTrackerWeb.static_paths()
    end
  end
